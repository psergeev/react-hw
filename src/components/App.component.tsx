...
import { HeaderWithSearch } from './header-with-search/HeaderWithSearch.component';
import { BodyWithResults } from './body-with-results/BodyWithResults.component';
import { Footer } from './footer/Footer.component';
import { HeaderWithDetails } from './header-with-detials/HeaderWithDetails.component';
...
export class App extends React.PureComponent<{}, IAppState> {
    ...
    public render() {
        ...
        return (
            <main>
                ...
                <BodyWithResults handleMovieCardClick={this.handleMovieCardClick}
                                 genre={this.state.selectedMovie && this.state.selectedMovie.genres.join(' & ')}
    ...
    private _getHeaderComponent() {
        if (this.state.selectedMovie) {
            return (
                <HeaderWithDetails movie={this.state.selectedMovie}
